...
function OriannaMenu()
  ...
  Menu = scriptConfig("HTTF URF Orianna", "HTTF URF Orianna")
...
function Farm()
  ...
  if Q.ready and FarmQ and FarmQ2 <= ManaPercent() then
    ...
    for i, minion in pairs(EnemyMinions.objects) do
      ...
      if ValidTarget(minion, Q.range+Q.radius+100) then
        CastQ(minion)
      end
  ...
  if W.ready and FarmW and FarmW2 <= ManaPercent() then
    ...
    for i, minion in pairs(EnemyMinions.objects) do
      ...
      if ValidTarget(minion, W.range+W.radius+100) then
        CastW(minion)
      end
  ...
  if E.ready and FarmE and FarmE2 <= ManaPercent() then
    ...
    for i, minion in pairs(EnemyMinions.objects) do
      ...
      if ValidTarget(minion, E.range+100) then
        CastE(minion)
      end
